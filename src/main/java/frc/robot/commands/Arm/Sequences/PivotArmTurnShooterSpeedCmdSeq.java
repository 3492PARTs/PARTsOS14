...
public class PivotArmTurnShooterSpeedCmdSeq extends SequentialCommandGroup {
  /** Creates a new PivotArmTurnWarmUpShooterCmdSeq. */
  public PivotArmTurnShooterSpeedCmdSeq(double armAngle, double turnAngle, double shooterRPM, int red) {
