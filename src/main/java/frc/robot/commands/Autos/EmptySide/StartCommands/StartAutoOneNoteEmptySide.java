...
public class StartAutoOneNoteEmptySide extends Command {
  private int red = 1;

  /** Creates a new StartAutoCmd. */
  public StartAutoOneNoteEmptySide() {
  ...
  public void end(boolean interrupted) {
    CommandScheduler.getInstance().schedule(new AutoOneNoteEmptySide(red));
  }
